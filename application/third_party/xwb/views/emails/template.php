...
<head>
    ...
    <title><?php echo $email_title;?></title> <!-- The title tag shows in email notifications, like Android 4.4. -->
        ...
        <table role="presentation" aria-hidden="true" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="margin: auto;" class="email-container">
            <tr>
                <td style="padding: 20px 0; text-align: center">
                    <img src="<?php echo base_url('view_image').'?path='.getConfig('logo'); ?>" aria-hidden="true" width="100" height="100" alt="<?php echo getConfig('company_name'); ?>" border="0" style="height: auto; background: #dddddd; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                </td>
            </tr>
        </table>
        <!-- Email Header : END -->
