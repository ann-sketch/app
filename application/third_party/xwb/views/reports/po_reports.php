                ...
                <form class="form-horizontal" accept-charset="utf-8">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo lang('dt_heading_branch'); ?>: </label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              <select class="form-control search_opt" name="branches" id="branches">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo lang('department_label'); ?>: </label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              <select class="form-control search_opt" name="department" id="department">
                                <option value=""><?php echo lang('label_all'); ?></option>
                    ...
                    <table class="table table-striped table_po_reports">
                      <thead>
                        <tr>
                            ...
                            <th><?php echo lang('warranty_condition_label'); ?></th>
                            <th><?php echo lang('dt_heading_totalprice'); ?></th>
                            <th><?php echo lang('initiator_label'); ?></th>
                            <th><?php echo lang('dt_heading_certified_by'); ?></th>
                            <th><?php echo lang('dt_heading_date_certified'); ?></th>
                            <th><?php echo lang('pdf_prepared_by_label'); ?></th>
                        </tr>
                      </thead>
                      <tbody>
...
<script type="text/javascript">
    xwb_var.varGetPOReports = '<?php echo base_url('reports/getPOReports'); ?>';
